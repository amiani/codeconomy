...
class Heap {
    ...
    constructor(comparatorFunction) {
        ...
        this.heapContainer = [];
        this.compare = new comparator_1.Comparator(comparatorFunction);
    }
    ...
    heapifyUp(startIndex = this.heapContainer.length - 1) {
        while (this.hasParent(startIndex) &&
            !this.pairIsInCorrectOrder(this.parent(startIndex), this.heapContainer[startIndex])) {
